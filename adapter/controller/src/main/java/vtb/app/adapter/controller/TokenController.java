...
//    private final TokenService tokenService;
    ...
    @PostMapping(value ="/chat/sendtoken")
    ...
    private String getSessionId(String token) {
        ...
        try {
            ObjectNode node = objectMapper.readValue(decodedPayload, ObjectNode.class);
            sessionId = node.get(CONTEXT_USER_UUID_JSON_FIELD).toString();
